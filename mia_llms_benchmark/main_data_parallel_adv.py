...
def init_dataset(ds_info, model, tokenizer, batch_size, check_path=None, unlearning_method=None):
    ...
    # Process dataset
    dataset = dataset.map(
        lambda x: batch_nlloss(x, model, tokenizer, key='nlloss', unlearning_method=unlearning_method),
        batched=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--unlearning_method', type=str, default=None, help="None or refusal or negative_label")
